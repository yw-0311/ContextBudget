...
while [[ $# -gt 0 ]]; do
  case $1 in
    ...
    --help|-h)
      ...
      echo "  --dataset NAME             Dataset name (required, nq_hotpotqa)"
      echo "  --max_depth N              Max depth (default: 10)"
      echo "  --target N                 Target count (required, 2, 8, 16, 32)"
...
BASELINE_PATH_1="${DATA_ROOT}/nq_hotpotqa_train_multi_1/search_r1_processed/test.parquet"
ELASTIC_PATH_1="${DATA_ROOT}/nq_hotpotqa_train_multi_1/elastic_processed/test.parquet"

BASELINE_PATH_2="${DATA_ROOT}/nq_hotpotqa_train_multi_2/search_r1_processed/test.parquet"
ELASTIC_PATH_2="${DATA_ROOT}/nq_hotpotqa_train_multi_2/elastic_processed/test.parquet"

BASELINE_PATH_8="${DATA_ROOT}/nq_hotpotqa_train_multi_8/search_r1_processed/test.parquet"
ELASTIC_PATH_8="${DATA_ROOT}/nq_hotpotqa_train_multi_8/elastic_processed/test.parquet"

BASELINE_PATH_16="${DATA_ROOT}/nq_hotpotqa_train_multi_16/search_r1_processed/test.parquet"
ELASTIC_PATH_16="${DATA_ROOT}/nq_hotpotqa_train_multi_16/elastic_processed/test.parquet"

BASELINE_PATH_32="${DATA_ROOT}/nq_hotpotqa_train_multi_32/search_r1_processed/test.parquet"
ELASTIC_PATH_32="${DATA_ROOT}/nq_hotpotqa_train_multi_32/elastic_processed/test.parquet"
...
# Build command
CMD="python3 \"${EVA_ROOT}/modules/infer_nq_hotpotqa.py\" \
  --dataset \"${DATASET}\" \
  --parquet \"${PARQUET}\" \
