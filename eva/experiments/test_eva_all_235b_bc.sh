...
# change server infer
DATASET="bc"  # 数据集名称改为 nq_hotpotqa
TARGETS=("1")
...
declare -A MODEL_MAP=(
  ...
  ["/data/oss_bucket_0/shiyi/model/qwen-235-awq/"]="baseline_loop"
  ["/data/oss_bucket_0/shiyi/model/Qwen2.5-7B-Instruct/"]="summary_loop"
  ["/data/oss_bucket_0/shiyi/model/Qwen3-30B-A3B-Instruct-2507/"]="summary_loop"
  # ours dynamic 7B
  ["/data/oss_bucket_0/shiyi/experiments/BRANCH_V3/BRANCH_7B_RL_F1_RW_BS128_4_5_6_7_8_MIS/global_step_240/actor/hf"]="branch_loop branch_loop_wob summary_loop"
  # ours dynamic 30B
  ["/data/oss_bucket_0/shiyi/experiments/BRANCH_V3/BRANCH_30B_RL_F1_RW_BS128_4_5_6_7_8_MIS/global_step_200/actor/hf"]="branch_loop branch_loop_wob summary_loop"
  # ours dynamic 30B
  ["/data/oss_bucket_0/shiyi/experiments/BRANCH_V3/BRANCH_30B_RL_F1_RW_BS128_4_5_6_7_8_MIS/global_step_320/actor/hf"]="branch_loop branch_loop_wob summary_loop"
  # Search-R1 7B
  ["/data/oss_bucket_0/shiyi/experiments/BASELINE_V3/BASELINE_7B_RL_F1_RW_BS128_8K_MIS/global_step_140/actor/hf"]="baseline_loop summary_loop"
  # Search-R1 30B
  ["/data/oss_bucket_0/shiyi/experiments/BASELINE_V3/BASELINE_30B_RL_F1_RW_BS128_8K_MIS/global_step_380/actor/hf"]="baseline_loop baseline_loop_wbudget summary_loop"
  # fix budget
  ["/data/oss_bucket_0/shiyi/experiments/BRANCH_V3/BRANCH_7B_RL_F1_RW_BS128_4_8_MIS/global_step_200/actor/hf/"]="branch_loop summary_loop"
)
