...
"""
Preprocess the QA dataset to parquet format for training
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='./data_all_raw_train/nq_hotpotqa_train_multi_3')
    ...
    for data_source in data_sources:
        ...
        print(f"[{data_source}] length of train_dataset: {len(train_dataset)}")
    ...
    print(f"[save] {os.path.join(local_dir, 'train.parquet')} (rows={len(all_train_dataset)})")