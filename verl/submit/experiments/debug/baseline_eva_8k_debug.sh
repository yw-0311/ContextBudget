...
# /data/oss_bucket_0/shiyi/data/search_r1/test_sub_elastic.parquet
# /data/oss_bucket_0/shiyi/data/search_r1/search_r1_subset_test.parquet
...
PROJECT_NAME="TEST_TENSORBOARD"
EXPERIMENT_NAME="BASELINE_30B_EM_RW_EVA_CLIP"
...
python3 -m verl.trainer.main_ppo \
    ...
    --config-name="1_eva_8k" \
    +trainer.validation_data_dir="$TENSORBOARD_DIR/eva_rollout_not_skip_mask/" \
    ...
    data.val_files="$DATA_DIR/mh_test.parquet"  \
