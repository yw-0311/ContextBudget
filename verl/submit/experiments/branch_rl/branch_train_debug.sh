...
BASE_MODEL="/home/wy517954/model/Qwen/Qwen2.5-7B-Instruct"

PROJECT_NAME="TRAIN_DEBUG_DEPTH"
EXPERIMENT_NAME="BRANCH_30B_RL_EM_RW_GSPO_BS128"
...
python3 -m verl.trainer.main_ppo \
    ...
    data.val_files="$DATA_DIR/elastic_processed/test.parquet"  \
