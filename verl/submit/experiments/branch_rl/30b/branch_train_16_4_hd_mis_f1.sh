...
DATA_DIR="/data/oss_bucket_0/shiyi/data/train_data/nq_hotpotqa_train_multi_2"
...
PROJECT_NAME="BRANCH_V3"
EXPERIMENT_NAME="BRANCH_30B_RL_F1_RW_BS128_16_4_MIS"
...
python3 -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.rollout.dynamic_max_model_len_list=[4096,6144,8192,10240,12288,14336] \
    ...
    data.train_files="$DATA_DIR/elastic_processed/train.parquet" \
    data.val_files="$DATA_DIR/elastic_processed/train.parquet"  \
